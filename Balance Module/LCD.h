...
//    }
    LCD_busy2(portNumber, RWPort, RWPin, RSPort, RSPin, EPort, EPin);
//    writeChar(portNumber, RWPort, RWPin, RSPort, RSPin, EPort, EPin, c);
    if(num == 0){
...
void cursorCentered(int portNumber, int RWPort, int RWPin, int RSPort, int RSPin, int EPort, int EPin, char* string)
{
    int l = length(string);
    int x = 0;
    int j = 0;
